/**
 * Analyse les pauses méridiennes dans un planning généré
 * Vérifie que chaque groupe a bien une pause d'au moins 90 minutes entre 12:00 et 14:00
 */

import { Schedule } from '../src/schedule';

console.log('🔍 ANALYSE DES PAUSES MÉRIDIENNES');
console.log('='.repeat(60));

// Créer et résoudre un planning
